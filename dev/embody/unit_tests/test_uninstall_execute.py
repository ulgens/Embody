...
class TestUninstallExecute(EmbodyTestCase):
    ...
    def test_edited_generated_file_kept(self):
        ...
        self.assertTrue(self._exists("CLAUDE.md"), "an edited generated file must survive uninstall")
    ...
    def test_mcp_envoy_removed_other_server_kept(self):
        self._w(
            ".mcp.json",
            json.dumps({"mcpServers": {"envoy": {"type": "stdio"}, "other": {"url": "x"}}}),
        )
        self._run()
