...
class TestClaudeConfig(EmbodyTestCase):
    ...
    def test_A03_templates_comp_exists(self):
        ...
        self.assertIsNotNone(templates_comp, "templates COMP not found inside Embody")
    ...
    def test_A04_all_rule_dats_exist(self):
        ...
        for dat_name in self.embody_ext._TEMPLATE_MAP_RULES:
            ...
            self.assertIsNotNone(dat, f"Rule DAT {dat_name!r} missing from templates COMP")
    ...
    def test_A05_all_skill_dats_exist(self):
        ...
        for dat_name in self.embody_ext._TEMPLATE_MAP_SKILLS:
            dat = templates_comp.op(dat_name)
            self.assertIsNotNone(dat, f"Skill DAT {dat_name!r} missing from templates COMP")
    ...
    def test_A06_all_rule_dats_have_content(self):
        ...
        for dat_name in self.embody_ext._TEMPLATE_MAP_RULES:
            dat = templates_comp.op(dat_name)
            self.assertTrue(dat.text, f"Rule DAT {dat_name!r} has empty .text")
    ...
    def test_A07_all_skill_dats_have_content(self):
        ...
        for dat_name in self.embody_ext._TEMPLATE_MAP_SKILLS:
            dat = templates_comp.op(dat_name)
            self.assertTrue(dat.text, f"Skill DAT {dat_name!r} has empty .text")
    ...
    def test_A08_all_rule_dats_have_marker(self):
        ...
        for dat_name in self.embody_ext._TEMPLATE_MAP_RULES:
            dat = templates_comp.op(dat_name)
            self.assertIn(self.MARKER, dat.text, f"Rule DAT {dat_name!r} missing marker")
    ...
    def test_A09_all_skill_dats_have_marker(self):
        ...
        for dat_name in self.embody_ext._TEMPLATE_MAP_SKILLS:
            dat = templates_comp.op(dat_name)
            self.assertIn(self.MARKER, dat.text, f"Skill DAT {dat_name!r} missing marker")
    ...
    def test_A11_text_claude_dat_has_marker(self):
        ...
        dat = self.embody_ext.my.op("templates/text_claude")
        self.assertIn(self.MARKER, dat.text, "text_claude DAT missing marker")
    ...
    def test_A14_text_agents_md_has_marker(self):
        ...
        templates_comp = self.embody_ext.my.op("templates")
        dat = templates_comp.op("text_agents_md")
        self.assertIn(self.MARKER, dat.text, "text_agents_md DAT missing marker")
    ...
    def test_A15_rule_slugs_are_simple_strings(self):
        ...
        for dat_name, slug in self.embody_ext._TEMPLATE_MAP_RULES.items():
            self.assertNotIn("/", slug, f"{dat_name}: slug {slug!r} should not contain slashes")
            self.assertNotIn("\\", slug, f"{dat_name}: slug {slug!r} should not contain backslashes")
    ...
    def test_B01_creates_file_when_missing(self):
        ...
        result = self.embody_ext._writeTemplate(self._temp_dir, "test/new.md", "content here")
    ...
    def test_B02_created_content_matches_input(self):
        ...
        self.embody_ext._writeTemplate(self._temp_dir, "exact.md", content)
    ...
    def test_B03_overwrites_file_with_marker(self):
        ...
        result = self.embody_ext._writeTemplate(self._temp_dir, "marked.md", "new content")
        self.assertTrue(result)
    ...
    def test_B04_skips_file_without_marker(self):
        ...
        result = self.embody_ext._writeTemplate(self._temp_dir, "user.md", "attempted overwrite")
        self.assertFalse(result)
        self.assertEqual(target.read_text(encoding="utf-8"), "User wrote this")

    def test_B05_creates_parent_directories(self):
        """_writeTemplate should create parent directories as needed."""
        result = self.embody_ext._writeTemplate(self._temp_dir, "a/b/c/deep.md", "deep content")
        self.assertTrue(result)
    ...
    def test_B06_returns_true_on_overwrite(self):
        ...
        result = self.embody_ext._writeTemplate(self._temp_dir, "retval.md", self.MARKER + " v2")
        self.assertTrue(result)

    def test_B07_empty_content_still_writes(self):
        """_writeTemplate should write even when content is empty string."""
        result = self.embody_ext._writeTemplate(self._temp_dir, "empty.md", "")
        self.assertTrue(result)
        self.assertTrue((self._temp_dir / "empty.md").exists())
        self.assertEqual((self._temp_dir / "empty.md").read_text(encoding="utf-8"), "")
    ...
    def test_B08_preserves_user_edits_to_generated_file(self):
        ...
        self.embody_ext._writeTemplate(self._temp_dir, "gen.md", self.MARKER + " v1 -->\nbody\n")
        target = self._temp_dir / "gen.md"
        # User edits the body but leaves the marker in place.
        target.write_text(self.MARKER + " v1 -->\nbody EDITED\n", encoding="utf-8")
        result = self.embody_ext._writeTemplate(self._temp_dir, "gen.md", self.MARKER + " v2 -->\nnew body\n")
    ...
    def test_B09_regenerates_untouched_generated_file(self):
        ...
        self.assertEqual((self._temp_dir / "gen.md").read_text(encoding="utf-8"), new)
    ...
    def test_B10_legacy_marker_without_tracked_hash_regenerates(self):
        ...
        result = self.embody_ext._writeTemplate(self._temp_dir, "legacy.md", self.MARKER + " v6 -->\nnew\n")
        self.assertTrue(result, "legacy marker file with no tracked hash should regenerate")
    ...
    def test_B11_generated_files_stay_byte_identical(self):
        ...
        self.assertEqual((self._temp_dir / "exact2.md").read_text(encoding="utf-8"), content)
    ...
    def test_C04_falls_back_to_envoy_md_without_marker(self):
        ...
        self.assertEqual(user_claude.read_text(encoding="utf-8"), "My own claude config")
    ...
    def test_D02_file_content_matches_dats(self):
        ...
        for dat_name, slug in self.embody_ext._TEMPLATE_MAP_RULES.items():
            ...
            self.assertEqual(actual, expected, f"Content mismatch for rules/{slug}.md")
    ...
    def test_Db04_cursor_files_have_description(self):
        ...
        for mdc_file in cursor_dir.glob("*.mdc"):
            content = mdc_file.read_text(encoding="utf-8")
            self.assertIn("description:", content, f"{mdc_file.name}: missing description field")
    ...
    def test_Db05_cursor_files_have_marker(self):
        ...
        for mdc_file in cursor_dir.glob("*.mdc"):
            content = mdc_file.read_text(encoding="utf-8")
            self.assertIn(self.MARKER, content, f"{mdc_file.name}: missing generated-by marker")
    ...
    def test_Dc04_copilot_individual_files_have_apply_to(self):
        ...
        for f in instructions_dir.glob("*.instructions.md"):
            ...
            self.assertIn("applyTo:", content, f"{f.name}: missing applyTo frontmatter")
    ...
    def test_Dc05_copilot_individual_files_have_marker(self):
        ...
        for f in instructions_dir.glob("*.instructions.md"):
            content = f.read_text(encoding="utf-8")
            self.assertIn(self.MARKER, content, f"{f.name}: missing generated-by marker")
    ...
    def test_Dd04_windsurf_content_matches_rule_dats(self):
        ...
        for dat_name, slug in self.embody_ext._TEMPLATE_MAP_RULES.items():
            ...
            self.assertEqual(actual, dat.text, f"Content mismatch for {slug}.md")
    ...
    def test_E01_claudecode_missing_when_no_files(self):
        ...
        self.assertTrue(self.embody_ext._clientFilesMissing(self._temp_dir, "claudecode"))
    ...
    def test_E02_claudecode_not_missing_when_all_present(self):
        ...
        self.assertFalse(self.embody_ext._clientFilesMissing(self._temp_dir, "claudecode"))
    ...
    def test_E05_cursor_missing_when_no_files(self):
        ...
        self.assertTrue(self.embody_ext._clientFilesMissing(self._temp_dir, "cursor"))
    ...
    def test_E06_cursor_not_missing_when_rules_exist(self):
        ...
        self.assertFalse(self.embody_ext._clientFilesMissing(self._temp_dir, "cursor"))

    def test_E07_copilot_missing_when_no_files(self):
        """copilot: missing when .github/copilot-instructions.md does not exist."""
        self.assertTrue(self.embody_ext._clientFilesMissing(self._temp_dir, "copilot"))
    ...
    def test_E08_copilot_not_missing_when_file_exists(self):
        ...
        self.assertFalse(self.embody_ext._clientFilesMissing(self._temp_dir, "copilot"))

    def test_E09_windsurf_missing_when_no_files(self):
        """windsurf: missing when .windsurf/rules does not exist."""
        self.assertTrue(self.embody_ext._clientFilesMissing(self._temp_dir, "windsurf"))
    ...
    def test_E10_windsurf_not_missing_when_rules_exist(self):
        ...
        self.assertFalse(self.embody_ext._clientFilesMissing(self._temp_dir, "windsurf"))

    def test_E11_none_never_missing(self):
        """none client: _clientFilesMissing always returns False."""
        self.assertFalse(self.embody_ext._clientFilesMissing(self._temp_dir, "none"))

    def test_E12_unknown_client_never_missing(self):
        """Unknown client string: _clientFilesMissing returns False (safe default)."""
        self.assertFalse(self.embody_ext._clientFilesMissing(self._temp_dir, "unknowntool"))

    def test_E13_gemini_missing_when_no_file(self):
        """gemini: missing when GEMINI.md does not exist."""
        self.assertTrue(self.embody_ext._clientFilesMissing(self._temp_dir, "gemini"))
    ...
    def test_E14_gemini_not_missing_when_file_exists(self):
        ...
        self.assertFalse(self.embody_ext._clientFilesMissing(self._temp_dir, "gemini"))

    def test_E15_codex_never_missing(self):
        """codex: covered by the always-written AGENTS.md, so never 'missing'."""
        self.assertFalse(self.embody_ext._clientFilesMissing(self._temp_dir, "codex"))
    ...
    def test_F03_returned_path_contains_git(self):
        ...
        result = self.embody_ext._findProjectRoot()
        self.assertTrue((result / ".git").exists(), f"No .git found at {result}")
    ...
    def test_G01_template_content_matches_repo(self):
        ...
        self.assertEqual(drifted, [], "Template drift detected:\n" + "\n".join(drifted))
    ...
    def test_G02_exclusions_are_valid(self):
        ...
        for name in self._DRIFT_EXCLUSIONS:
            self.assertIn(
                name,
                self.embody_ext._TEMPLATE_MAP_RULES,
