...
class TestMCPAnnotations(EmbodyTestCase):
    ...
    def test_create_annotation_default_mode(self):
        ...
        result = self.envoy._create_annotation(parent_path=self.workspace.path)
    ...
    def test_create_annotation_comment_mode(self):
        ...
        result = self.envoy._create_annotation(parent_path=self.workspace.path, mode="comment")
        self.assertTrue(result.get("success"))

    def test_create_annotation_networkbox_mode(self):
        """_create_annotation with networkbox mode should succeed."""
        result = self.envoy._create_annotation(parent_path=self.workspace.path, mode="networkbox")
        self.assertTrue(result.get("success"))
    ...
    def test_create_annotation_with_text(self):
        ...
        result = self.envoy._create_annotation(parent_path=self.workspace.path, text="Hello annotation")
        self.assertTrue(result.get("success"))
        ann = op(result["path"])
    ...
    def test_create_annotation_with_title(self):
        ...
        result = self.envoy._create_annotation(parent_path=self.workspace.path, title="My Title")
        self.assertTrue(result.get("success"))
        ann = op(result["path"])
    ...
    def test_create_annotation_with_position(self):
        ...
        result = self.envoy._create_annotation(parent_path=self.workspace.path, x=100, y=200)
        self.assertTrue(result.get("success"))
    ...
    def test_create_annotation_with_size(self):
        ...
        result = self.envoy._create_annotation(parent_path=self.workspace.path, width=500, height=300)
        self.assertTrue(result.get("success"))
    ...
    def test_create_annotation_with_name(self):
        ...
        result = self.envoy._create_annotation(parent_path=self.workspace.path, name="my_note")
        self.assertTrue(result.get("success"))
    ...
    def test_create_annotation_with_color(self):
        ...
        result = self.envoy._create_annotation(parent_path=self.workspace.path, color=[0.8, 0.2, 0.1])
        self.assertTrue(result.get("success"))
        ann = op(result["path"])
    ...
    def test_create_annotation_invalid_mode(self):
        ...
        result = self.envoy._create_annotation(parent_path=self.workspace.path, mode="invalid_mode")
        self.assertDictHasKey(result, "error")

    def test_create_annotation_invalid_parent(self):
        """_create_annotation with nonexistent parent should return error."""
        result = self.envoy._create_annotation(parent_path="/nonexistent/path")
        self.assertDictHasKey(result, "error")
    ...
    def test_get_annotations_returns_list(self):
        ...
        result = self.envoy._get_annotations(parent_path=self.workspace.path)
    ...
    def test_get_annotations_finds_created(self):
        ...
        self.envoy._create_annotation(parent_path=self.workspace.path, text="findme")
        result = self.envoy._get_annotations(parent_path=self.workspace.path)
    ...
    def test_get_annotations_invalid_parent(self):
        ...
        result = self.envoy._get_annotations(parent_path="/nonexistent/path")
        self.assertDictHasKey(result, "error")
    ...
    def test_set_annotation_modify_text(self):
        ...
        create_result = self.envoy._create_annotation(parent_path=self.workspace.path, text="original")
        result = self.envoy._set_annotation(op_path=create_result["path"], text="modified")
        self.assertTrue(result.get("success"))
    ...
    def test_set_annotation_modify_title(self):
        ...
        create_result = self.envoy._create_annotation(parent_path=self.workspace.path, title="old title")
        result = self.envoy._set_annotation(op_path=create_result["path"], title="new title")
        self.assertTrue(result.get("success"))
    ...
    def test_set_annotation_nonexistent(self):
        ...
        result = self.envoy._set_annotation(op_path="/nonexistent/ann", text="test")
        self.assertDictHasKey(result, "error")
    ...
    def test_get_enclosed_ops_annotation(self):
        ...
        result = self.envoy._get_enclosed_ops(op_path=create_result["path"])
    ...
    def test_get_enclosed_ops_nonexistent(self):
        ...
        result = self.envoy._get_enclosed_ops(op_path="/nonexistent/path")
        self.assertDictHasKey(result, "error")
    ...
    def test_set_annotation_resolves_utility_flagged(self):
        ...
        just listed).
        """
        create_result = self.envoy._create_annotation(parent_path=self.workspace.path, title="util resolve")
        ann_path = create_result["path"]
        ann = self.envoy._resolve_annotation(ann_path)
        self.assertIsNotNone(ann)
        ann.utility = True  # match TD UI behavior

        result = self.envoy._set_annotation(op_path=ann_path, title="resolved anyway", width=555)
        self.assertFalse(
            "error" in result,
            "set_annotation failed on utility-flagged annotation: {}".format(result.get("error")),
        )
    ...
    def test_get_enclosed_ops_resolves_utility_flagged(self):
        ...
        self.assertFalse(
            "error" in result,
            "_get_enclosed_ops failed on utility-flagged annotation: {}".format(result.get("error")),
        )
        self.assertTrue(result.get("is_annotation"))
