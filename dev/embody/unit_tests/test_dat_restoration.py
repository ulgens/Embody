...
class TestDATRestoration(EmbodyTestCase):
    ...
    def test_restore_skips_dat_inside_tox_comp(self):
        ...
        self._add_table_entry(comp_path, "container", "tox", "embody/unit_tests/_test_temp/tox_parent.tox")
        ...
        entries = self.embody_ext._getDATEntries()
        paths = [e[0] for e in entries]
        self.assertNotIn(dat_path, paths, "DATs inside TOX COMPs should be excluded")
    ...
    def test_restore_skips_dat_inside_tdn_comp(self):
        ...
        self._add_table_entry(comp_path, "container", "tdn", "embody/unit_tests/_test_temp/tdn_parent.tdn")
        ...
        entries = self.embody_ext._getDATEntries()
        paths = [e[0] for e in entries]
        self.assertNotIn(dat_path, paths, "DATs inside TDN COMPs should be excluded")
    ...
    def test_restore_disabled_by_toggle(self):
        ...
        try:
            self.embody_ext.RestoreDATs()
            self.assertIsNone(op(dat_path), "DAT should not be restored when toggle is off")
        finally:
    ...
    def test_continuity_protects_recoverable_dat(self):
        ...
        self.assertTrue(self._table_has_path(dat_path), "Recoverable DAT entry should be preserved")
    ...
    def test_continuity_removes_unrecoverable_entry(self):
        ...
        self.assertFalse(self._table_has_path(dat_path), "Unrecoverable entry should be removed")
    ...
    def test_continuity_protects_recoverable_tox(self):
        ...
        self.assertTrue(self._table_has_path(comp_path), "Recoverable TOX entry should be preserved")
