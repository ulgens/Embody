...
class TestExternalization(EmbodyTestCase):
    ...
    def test_setupComp_sets_externaltox(self):
        ...
        self.embody_ext._setupCompForExternalization(comp, rel_path, str(self.embody_ext.buildAbsolutePath(rel_path)))
    ...
    def test_setupDat_sets_file(self):
        ...
        self.embody_ext._setupDatForExternalization(dat, rel_path, str(self.embody_ext.buildAbsolutePath(rel_path)))
