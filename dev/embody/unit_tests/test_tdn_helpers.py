...
class TestTDNHelpers(EmbodyTestCase):
    ...
    def test_deserializeStorageValue_tuple(self):
        result = self.tdn._deserializeStorageValue({"$type": "tuple", "$value": [1, 2]})
        self.assertEqual(result, (1, 2))
        self.assertIsInstance(result, tuple)

    def test_deserializeStorageValue_set(self):
        result = self.tdn._deserializeStorageValue({"$type": "set", "$value": ["a", "b"]})
    ...
    def test_deserializeStorageValue_bytes(self):
        ...
        result = self.tdn._deserializeStorageValue({"$type": "bytes", "$value": encoded})
    ...
    def test_deserializeStorageValue_unknown_type(self):
        ...
        result = self.tdn._deserializeStorageValue({"$type": "unknown", "$value": "x"})
