...
class TestToxdropExpr(EmbodyTestCase):
    ...
    def setUp(self):
        ...
        self._saved_resp = self.embody.fetch("_smoke_test_responses", None, search=False)
    ...
    def _seed(self, button_index):
        self.embody.store("_smoke_test_responses", {self.DIALOG_TITLE: button_index})
    ...
    def test_ask_clean_resets_without_persisting(self):
        ...
        self.assertEqual(
            self.embody.par.Toxdropexpr.eval(),
            "ask",
    ...
    def test_dialog_dismissed_is_noop(self):
        ...
        self.embody.unstore("_smoke_test_responses")
        self.embody_ext._resolveToxdropExternals([comp])
        self.assertTrue(self._dropped(comp), "a dismissed/suppressed dialog must not clear anything")
        self.assertEqual(self.embody.par.Toxdropexpr.eval(), "ask")
    ...
    def test_preference_clean_is_silent(self):
        ...
        self.embody.unstore("_smoke_test_responses")
        self.embody_ext._resolveToxdropExternals([comp])
        self.assertFalse(self._dropped(comp), "'clean' must reset silently")
    ...
    def test_preference_ignore_is_silent(self):
        ...
        self.embody.unstore("_smoke_test_responses")
        self.embody_ext._resolveToxdropExternals([comp])
        self.assertTrue(self._dropped(comp), "'ignore' must leave the expression silently")
    ...
    def test_dialog_body_truncates(self):
        ...
        self.assertEqual(listed, cap, f"exactly {cap} paths should be listed, got {listed}")
        self.assertIn(
            f"... and {overflow} more",
            message,
